...
describe('cli', () => {
  describe('should parse single arguments', () => {
    it('--targetBranch to targetBranch', () => {
      const parsedArgs = parseArgumentsIntoOptions([
        ...BASE_ARGS,
        '--targetBranch',
        'testArg',
      ]);
  ...
  describe('should parse multiple arguments', () => {
    it('should parse 2 arguments correctly in different order', () => {
      const opts1 = parseArgumentsIntoOptions([
        ...BASE_ARGS,
        '-t',
        'branch',
        '--mode',
      ...
      const opts2 = parseArgumentsIntoOptions([
        ...BASE_ARGS,
        '--mode',
        'modeArg',
        '-t',
    ...
    it('should parse 3 or more arguments correctly in different order', () => {
      ...
      const opts3 = parseArgumentsIntoOptions([
        ...BASE_ARGS,
        '--mode',
        'modeArg',
        '--webpackConfig',
